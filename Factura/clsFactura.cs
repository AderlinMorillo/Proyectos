...
namespace Factura
{
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            public static string LineasGuionBajo()
            {
                string LineaGuionBajo = "________________________________";   // agrega lineas separadoras bajas _
                return line.AppendLine(LineaGuionBajo).ToString();
            }


            public static void EncabezadoVenta()
            {
                string LineEncavesado = "Prod.     Cant.   Precio   Total";   // agrega lineas del encabezados
            ...
            public void TextoExtremos(string par1, string par2)
            {
                ...
                {
                    cort = max - 16;
                    parte1 = par1.Remove(16, cort);          // si par1 es mayor que 16 lo corta
                }
                else { parte1 = par1; }                      // **********
                ...
                {
                    cort = max - 16;
                    parte2 = par2.Remove(16, cort);          // si par2 es mayor que 18 lo corta
                }
                else { parte2 = par2; }
            ...
            {
                if (cant.ToString().Length <= 10 && precio.ToString("c").Length <= 10 && subtotal.ToString("c").Length <= 12) // valida que cant precio y total esten dentro de rango
                {
                    ...
                    {
                        cort = max - 12;
                        parte1 = Articulo.Remove(12, cort);          // corta a 12 la descripcion del articulo
                        ...
                        nroEspacios = (4 - subtotal.ToString().Length);
                        espacios = "";
                        ...
                        for (int Longtext = Articulo.Length; Longtext > 31; Longtext++)
                        {
                            if (bandera == false)
                            {
                                line.AppendLine(Articulo.Substring(CaracterActual, 11) + elementos);
                                bandera = true;
                            }
                            else
                            {
                                line.AppendLine(Articulo.Substring(CaracterActual, 11));
                    ...
                    {
                        for (int i = 0; i < (11 - Articulo.Length); i++)
                        {
                            espacios += " ";
